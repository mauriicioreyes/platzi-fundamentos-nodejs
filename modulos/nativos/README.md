...
7. El módulo se compilará, y podrás importarlo en JavaScript.
Puedes revisar que exista el archivo `build/Release/addon.node` _(es un binario, así que no podrás abrirlo)._
